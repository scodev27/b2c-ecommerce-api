...
class getMessenger_Bus_Default_Middleware_SendMessageService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $a = ($container->privates['.service_locator.RIxl4HG'] ?? $container->load('get_ServiceLocator_RIxl4HGService'));
        ...
        $instance = new \Symfony\Component\Messenger\Middleware\SendMessageMiddleware(new \Symfony\Component\Messenger\Transport\Sender\SendersLocator(['App\\Message\\SendEmailMessage' => ['async']], $a), $b, true);
