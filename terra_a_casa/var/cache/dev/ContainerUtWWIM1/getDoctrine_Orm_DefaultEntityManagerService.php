...
class getDoctrine_Orm_DefaultEntityManagerService extends App_KernelDevContainer
{
    ...
    {
        if (true === $lazyLoad) {
            return $container->services['doctrine.orm.default_entity_manager'] = $container->createProxy('EntityManagerGhost4c60c49', static fn () => \EntityManagerGhost4c60c49::createLazyGhost(static fn ($proxy) => self::do($container, $proxy)));
        }
